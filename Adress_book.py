...
def editor_screen(root, elem, k):
	global full_name_editor, phone_number_editor, adress_editor, state_value_editor, zip_code_editor, city_editor, to_edit, edit_window
	cnx = sqlite3.connect("adress_book.db")
	cursor = cnx.cursor()
	elem = str(elem)
	...
	state_value_editor = IntVar()
	state_value_editor.set(state_list[0])
	state_lbl_editor = Label(root, text="state")
	state_editor= OptionMenu(root,state_value, *state_list)
...
def save(oid, k):
	global window, full_name_editor, phone_number_editor, adress_editor, state_value_editor, zip_code_editor, city_editor, to_edit, edit_window, oids_and_checkboxes
	cnx = sqlite3.connect("adress_book.db")
	cursor = cnx.cursor()
